...
import { toggleSignin, siderCollapsed, login } from '../../../actions/actionTypes';
    ...
    render() {
      ...
      return (
            <div className="header-box">
                ...
                {collapsed && mobile && <div className="overlay" onClick={toggleSiderMenu} />}
            </div>
      );
    }
}
...
const mapStateToProps = ({
  screenSize, auth, sign, notifications,
}) => ({
  screenSize, auth, sign, notifications,
});
