...
class Notifications extends Component {
  ...
  _renderNotificationsItems = () => {
    ...
    items.forEach((notification, key) => {
      const currentNotification = <NotificationItem onNotificationClick={this.onNotificationClick} key={key}
                                                    item={notification}/>;
    ...
    const notificationsMenu = (
      <div className="notifications">
        ...
        <Scrollbars style={{width: '350px'}} autoHeight
                    ...
                    onScrollFrame={values => setTimeout(() => {
                      this.onScrollFrame(values);
                    }, 300)}
